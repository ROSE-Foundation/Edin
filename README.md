...
Edin is not a productivity suite — it is an integration-first platform that connects to existing tools (GitHub, Google Workspace, Slack), analyzes contributor output, and translates quality and impact into fair rewards.

## Architecture

The platform is structured around five functional layers:

1. **Integration Layer** — Connectors to external development and collaboration tools
2. **Web Portal** — Hybrid SPA/MPA interface for contributors and administrators
3. **AI Evaluation Engine** — Multi-domain contribution analysis and scoring
4. **Multi-Scale Reward System** — Token distribution engine with power-law compounding
5. **Governance Layer** — Progressive decentralization from foundation-led to community-governed

## Context

Built within the IOUR Foundation (Belgian non-profit), Edin operates at the intersection of AI transformation of work, the open-source sustainability crisis, and blockchain economics maturity. The project is subject to EU regulatory frameworks including MiCA, GDPR, and the EU AI Act.
...
Documents generated through the [BMAD Method](https://github.com/bmadcode/BMAD-METHOD) structured product development workflow.
...
- **Phase:** Pre-MVP — Planning & Specification
- **PRD Status:** Complete (2026-02-27)
- **Next Steps:** UX Design, Technical Architecture, Epics & Stories, Implementation Readiness Check
