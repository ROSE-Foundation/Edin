    ...
    return (
      <div className="space-y-[var(--spacing-md)]">
        {[1, 2].map((i) => (
          <div
            key={i}
            className="h-[100px] animate-pulse rounded-[12px] border border-surface-subtle bg-surface-raised"
          />
        ))}
      </div>
    );
    ...
    <div className="space-y-[var(--spacing-md)]">
      {assignments.map((assignment) => {
        ...
        return (
          <div
            key={assignment.id}
            className="rounded-[12px] border border-surface-subtle bg-surface-raised p-[var(--spacing-lg)] shadow-sm transition-shadow duration-200 hover:shadow-md motion-reduce:transition-none"
          >
            <div className="flex items-start justify-between gap-[var(--spacing-md)]">
              <div className="min-w-0 flex-1">
                ...
                <h3 className="mt-[var(--spacing-xs)] truncate font-sans text-[14px] font-medium text-text-primary">
              ...
              <Link
                ...
                className="inline-flex min-h-[36px] items-center rounded-[var(--radius-md)] bg-accent-primary px-[var(--spacing-md)] font-sans text-[13px] font-medium text-white transition-[background-color] duration-[var(--transition-fast)] hover:bg-accent-primary/90 motion-reduce:transition-none"
              >
                Review
              </Link>
            </div>
