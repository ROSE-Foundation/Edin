        ...
        {components.map((component) => (
          ...
          >
            <div className="flex items-center gap-[var(--spacing-sm)]">
              ...
              <span className="ml-auto rounded-full bg-surface-sunken px-[var(--spacing-sm)] py-[2px] font-sans text-[12px] text-brand-secondary">
                {component.qualitativeWeight}
              </span>
            </div>
            <p className="mt-[var(--spacing-sm)] font-serif text-[15px] leading-[1.6] text-brand-primary">
