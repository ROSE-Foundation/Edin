    ...
    >
      ...
      {paragraphs.length > 1 && (
        <details className="mt-[var(--spacing-md)]">
          <summary className="cursor-pointer font-sans text-[14px] font-medium text-accent-primary underline underline-offset-2 hover:opacity-80">
            Read more about the philosophy
          </summary>
          <div className="mt-[var(--spacing-sm)] space-y-[var(--spacing-md)]">
            {paragraphs.slice(1).map((p, i) => (
              <p key={i} className="font-serif text-[15px] leading-[1.6] text-text-primary">
                {p}
              </p>
            ))}
          </div>
      ...
      <div className="mt-[var(--spacing-xl)]">
        <h3 className="font-serif text-[clamp(1.1rem,2.5vw,1.25rem)] leading-[1.3] font-semibold text-text-primary">
        ...
        <div className="mt-[var(--spacing-md)] space-y-[var(--spacing-xs)]">
          {REWARD_METHODOLOGY.formulaComponents.map((component) => (
            ...
            >
              <summary className="cursor-pointer px-[var(--spacing-md)] py-[var(--spacing-sm)] font-sans text-[15px] font-semibold text-text-primary list-none">
                <span className="flex items-center gap-[var(--spacing-sm)]">
                  ...
                  <span className="ml-auto flex items-center gap-[var(--spacing-sm)]">
                    <span className="rounded-full bg-surface-sunken px-[var(--spacing-sm)] py-[2px] font-sans text-[12px] font-normal text-text-secondary">
              ...
              <div className="px-[var(--spacing-md)] pb-[var(--spacing-md)] font-serif text-[14px] leading-[1.6] text-text-secondary">
      ...
      <details className="mt-[var(--spacing-lg)]">
        ...
        <div className="mt-[var(--spacing-sm)] rounded-[8px] border border-surface-subtle bg-surface-raised p-[var(--spacing-md)]">
          <p className="font-serif text-[14px] leading-[1.6] text-text-primary">
