import type { GlossaryTerm } from '@edin/shared';
    ...
    >
      ...
      <div className="mt-[var(--spacing-lg)] space-y-[var(--spacing-xs)]">
        {terms.map((item) => (
          ...
          >
            <summary className="cursor-pointer px-[var(--spacing-md)] py-[var(--spacing-sm)] font-serif text-[15px] font-semibold text-brand-primary list-none">
            ...
            <div className="px-[var(--spacing-md)] pb-[var(--spacing-md)] font-sans text-[14px] leading-[1.6] text-brand-secondary">
              {item.definition}
            </div>
          </details>
        ))}
