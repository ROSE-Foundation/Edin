      ...
      <div className="mt-[var(--spacing-xs)] space-y-1 rounded-[var(--radius-sm)] bg-surface-base p-[var(--spacing-sm)] text-xs font-mono">
        {entry.errorMessage && (
          <div>
            ...
            <span className="text-text-primary">{entry.errorMessage}</span>
          </div>
        )}
        {entry.retryCount > 0 && (
          <div>
            <span className="font-semibold text-text-secondary">Retries:</span>{' '}
            <span className="text-text-primary">{entry.retryCount}</span>
          </div>
        )}
        {entry.payloadSummary && (
          <div>
            <span className="font-semibold text-text-secondary">Payload:</span>{' '}
            <span className="text-text-primary">{entry.payloadSummary}</span>
          </div>
        )}
        {entry.correlationId && (
          <div>
