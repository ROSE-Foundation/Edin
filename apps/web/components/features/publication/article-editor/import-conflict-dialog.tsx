        ...
        >
          ...
          <div className="mt-[var(--spacing-lg)] flex justify-end gap-[var(--spacing-sm)]">
            ...
            <button
              ...
              className="rounded-[var(--radius-md)] bg-accent-primary px-[var(--spacing-md)] py-[var(--spacing-sm)] font-sans text-[14px] font-medium text-white transition-colors duration-[var(--transition-fast)] hover:bg-accent-primary/90 focus-visible:outline-2 focus-visible:outline-accent-primary focus-visible:outline-offset-2"
            >
              Replace
            </button>
          </div>
