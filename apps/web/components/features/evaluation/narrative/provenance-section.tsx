...
export function ProvenanceSection({ provenance, rubric }: ProvenanceSectionProps) {
  ...
  return (
    <div className="rounded-[var(--radius-md)] border border-surface-subtle bg-surface-base">
      <button
        type="button"
      ...
      >
        ...
        <svg
          className={`h-[16px] w-[16px] shrink-0 text-text-secondary transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`}
          viewBox="0 0 16 16"
          fill="none"
          aria-hidden="true"
        >
      ...
      {isOpen && (
        <div className="border-t border-surface-subtle px-[var(--spacing-md)] py-[var(--spacing-md)]">
          <div className="mb-[var(--spacing-md)]">
            <h4 className="mb-[var(--spacing-xs)] font-sans text-[12px] font-medium uppercase tracking-wider text-text-secondary">
              Formula
            </h4>
            <p className="font-mono text-[13px] text-text-primary">{provenance.formulaVersion}</p>
          </div>
          ...
          {rubric && (
            <div className="mt-[var(--spacing-md)] border-t border-surface-subtle pt-[var(--spacing-md)]">
              ...
              <p className="font-mono text-[13px] text-text-primary">{rubric.version}</p>
            </div>
          )}
        </div>
      )}
