  ...
  if (status === 'PENDING' || status === 'IN_PROGRESS') {
    return (
      <span
        ...
        className="inline-flex items-center rounded-full px-[var(--spacing-sm)] py-[2px] font-sans text-[11px] font-medium text-text-secondary"
      >
  ...
  if (status === 'COMPLETED') {
    return (
      <span
        ...
        className="inline-flex items-center rounded-full bg-accent-primary/10 px-[var(--spacing-sm)] py-[2px] font-sans text-[11px] font-medium text-accent-primary/80"
      >
        Evaluated
      </span>
    );
