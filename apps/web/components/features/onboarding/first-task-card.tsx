...
export function FirstTaskCard({ task, isLoading }: FirstTaskCardProps) {
  ...
  if (!task) {
    return (
      <div className="rounded-[var(--radius-lg)] border border-surface-border bg-surface-raised p-[var(--spacing-lg)] shadow-[var(--shadow-card)]">
        <h3 className="font-sans text-[15px] font-medium text-brand-primary">Your First Task</h3>
    ...
    <div className="rounded-[var(--radius-lg)] border border-surface-border bg-surface-raised p-[var(--spacing-lg)] shadow-[var(--shadow-card)]">
      ...
      <div className="mt-[var(--spacing-md)]">
        <div className="flex items-center gap-[var(--spacing-sm)]">
          <h4 className="font-serif text-[18px] font-bold text-brand-primary">{task.taskTitle}</h4>
          {domainColor && (
            <span
        ...
        <Link
          ...
          className="mt-[var(--spacing-md)] inline-flex min-h-[44px] cursor-not-allowed items-center rounded-[var(--radius-md)] bg-brand-accent/40 px-[var(--spacing-md)] font-sans text-[15px] font-medium text-surface-raised"
