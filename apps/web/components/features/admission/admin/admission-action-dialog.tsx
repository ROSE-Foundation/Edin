        ...
        >
          ...
          <div className="mt-[var(--spacing-md)]">
            ...
            <textarea
              ...
              className="w-full resize-none rounded-[var(--radius-md)] border border-surface-subtle-input bg-surface-raised px-[var(--spacing-sm)] py-[var(--spacing-sm)] font-sans text-[14px] text-text-primary transition-[border-color] duration-[var(--transition-fast)] focus:border-accent-primary focus:ring-2 focus:ring-accent-primary/20 focus:outline-none"
              required={!isApprove}
            />
          </div>
          ...
          <div className="mt-[var(--spacing-lg)] flex justify-end gap-[var(--spacing-sm)]">
            ...
            <button
              ...
              className={`rounded-[var(--radius-md)] px-[var(--spacing-md)] py-[var(--spacing-sm)] font-sans text-[14px] font-medium transition-[background-color,opacity] duration-[var(--transition-fast)] focus-visible:outline-2 focus-visible:outline-offset-2 disabled:cursor-not-allowed disabled:opacity-50 ${
                isApprove
                  ? 'bg-accent-primary text-white hover:bg-accent-primary/90 focus-visible:outline-accent-primary'
                  : isRequestInfo
                    ? 'border border-accent-primary text-accent-primary hover:bg-accent-primary/5 focus-visible:outline-accent-primary'
