        ...
        <div role="status" aria-label="Loading buddy assignments">
          ...
          <div className="rounded-[var(--radius-lg)] border border-surface-border bg-surface-raised">
            ...
            <div className="flex border-b border-surface-border px-[var(--spacing-md)] py-[var(--spacing-sm)]">
              ...
              <div className="skeleton ml-[var(--spacing-xl)] h-[16px] w-[120px]" />
            ...
            {Array.from({ length: 6 }).map((_, i) => (
              ...
              >
                ...
                <div className="skeleton ml-[var(--spacing-xl)] h-[20px] w-[140px]" />
                <div className="skeleton ml-auto h-[24px] w-[80px] rounded-full" />
                <div className="skeleton ml-[var(--spacing-xl)] h-[16px] w-[90px]" />
                <div className="skeleton ml-[var(--spacing-xl)] h-[32px] w-[80px] rounded-[var(--radius-sm)]" />
              </div>
            ))}
          </div>
          <span className="sr-only">Loading buddy assignments</span>
        </div>
      </div>
    </main>
  );
