      ...
      <div className="max-w-2xl text-center">
        ...
        <div className="flex gap-[var(--spacing-md)] justify-center">
          <a
            ...
            className="inline-flex items-center gap-2 px-[var(--spacing-lg)] py-[var(--spacing-sm)] bg-brand-accent text-surface-raised font-sans text-[15px] font-medium rounded-[var(--radius-md)] transition-colors duration-[var(--transition-fast)] hover:opacity-90"
          >
