    ...
    <article className="docs-content">
      ...
      <section className="mt-[var(--spacing-2xl)]">
        ...
        <div className="mt-[var(--spacing-lg)] flex flex-col gap-[var(--spacing-md)]">
          ...
          >
            <h3 className="font-sans text-[15px] font-semibold text-text-primary">Technology</h3>
          ...
          >
            <h3 className="font-sans text-[15px] font-semibold text-text-primary">Governance</h3>
            <p className="mt-[var(--spacing-xs)] font-sans text-[14px] leading-[1.6] text-text-secondary">
      ...
      <section className="mt-[var(--spacing-2xl)]">
        ...
        <ul className="mt-[var(--spacing-sm)] flex flex-col gap-[var(--spacing-sm)] pl-[var(--spacing-md)]">
          <li className="font-sans text-[14px] leading-[1.6] text-text-secondary">
            <strong className="text-text-primary">Task coordination</strong> — domain-specific tasks
            organized by difficulty level, from beginner to advanced.
          </li>
          <li className="font-sans text-[14px] leading-[1.6] text-text-secondary">
            <strong className="text-text-primary">Knowledge sharing</strong> — a space for
            contributors to share insights, discuss approaches, and learn from each other.
          </li>
          <li className="font-sans text-[14px] leading-[1.6] text-text-secondary">
            <strong className="text-text-primary">Mentorship</strong> — experienced members guide
            newcomers and help them grow within the domain.
          </li>
          <li className="font-sans text-[14px] leading-[1.6] text-text-secondary">
            <strong className="text-text-primary">Community building</strong> — working groups
      ...
      <section className="mt-[var(--spacing-2xl)]">
        ...
        <p className="mt-[var(--spacing-md)] font-sans text-[15px] leading-[1.7] text-text-secondary">
          ...
          <strong className="text-text-primary">Dashboard &gt; Working Groups</strong>.
        </p>
        <p className="mt-[var(--spacing-sm)] font-sans text-[15px] leading-[1.7] text-text-secondary">
      ...
      <section className="mt-[var(--spacing-2xl)]">
        ...
        <p className="mt-[var(--spacing-md)] font-sans text-[15px] leading-[1.7] text-text-secondary">
          The <strong className="text-text-primary">Dashboard &gt; Activity</strong> page shows a
