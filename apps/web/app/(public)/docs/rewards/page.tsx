    ...
    <article className="docs-content">
      ...
      <section className="mt-[var(--spacing-2xl)]">
        ...
        <p className="mt-[var(--spacing-sm)] font-sans text-[15px] leading-[1.7] text-text-secondary">
          The key principle is <strong className="text-text-primary">compounding value</strong>.
      ...
      <section className="mt-[var(--spacing-2xl)]">
        ...
        <ul className="mt-[var(--spacing-sm)] flex flex-col gap-[var(--spacing-sm)] pl-[var(--spacing-md)]">
          <li className="font-sans text-[14px] leading-[1.6] text-text-secondary">
            <strong className="text-text-primary">AI Evaluation Score</strong> — the objective
            quality assessment from the AI engine (complexity, quality, test coverage, impact).
          </li>
          <li className="font-sans text-[14px] leading-[1.6] text-text-secondary">
            <strong className="text-text-primary">Peer Feedback Score</strong> — aggregated feedback
            from community members who reviewed the work.
          </li>
          <li className="font-sans text-[14px] leading-[1.6] text-text-secondary">
            <strong className="text-text-primary">Task Complexity</strong> — the difficulty level of
            the task or contribution type.
          </li>
        </ul>
      ...
      <section className="mt-[var(--spacing-2xl)]">
        ...
        <p className="mt-[var(--spacing-sm)] font-sans text-[15px] leading-[1.7] text-text-secondary">
          ...
          <Link href="/rewards/methodology" className="text-accent-primary hover:underline">
            Reward Methodology
          </Link>{' '}
          page.
        </p>
      ...
      <section className="mt-[var(--spacing-2xl)]">
        ...
        <p className="mt-[var(--spacing-md)] font-sans text-[15px] leading-[1.7] text-text-secondary">
          The <strong className="text-text-primary">Dashboard &gt; Rewards &gt; Trajectory</strong>{' '}
