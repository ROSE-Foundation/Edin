    ...
    <article className="docs-content">
      ...
      <section className="mt-[var(--spacing-2xl)]">
        ...
        <ul className="mt-[var(--spacing-sm)] flex flex-col gap-[var(--spacing-sm)] pl-[var(--spacing-md)]">
          <li className="font-sans text-[14px] leading-[1.6] text-text-secondary">
            <strong className="text-text-primary">AI-powered evaluation</strong> — every
            contribution is objectively scored across quality, complexity, and impact.
          </li>
          <li className="font-sans text-[14px] leading-[1.6] text-text-secondary">
            <strong className="text-text-primary">Scaling-law rewards</strong> — mathematical models
            that reward sustained engagement with compounding returns.
          </li>
          <li className="font-sans text-[14px] leading-[1.6] text-text-secondary">
            <strong className="text-text-primary">Curated admission</strong> — quality through
        ...
        <div className="mt-[var(--spacing-lg)] grid grid-cols-1 gap-[var(--spacing-md)] sm:grid-cols-2">
          {QUICK_LINKS.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className="group rounded-[var(--radius-lg)] border border-surface-subtle bg-surface-raised p-[var(--spacing-md)] transition-all duration-[var(--transition-fast)] hover:border-accent-primary hover:shadow-card"
            >
              <h3 className="font-sans text-[15px] font-semibold text-text-primary group-hover:text-accent-primary">
                {link.title}
              </h3>
      ...
      <section className="mt-[var(--spacing-2xl)]">
        ...
        <p className="mt-[var(--spacing-sm)] font-sans text-[15px] leading-[1.7] text-text-secondary">
          ...
          <strong className="text-text-primary">Apply</strong> to join the community,{' '}
          <strong className="text-text-primary">Contribute</strong> through your domain of
          expertise, get <strong className="text-text-primary">Evaluated</strong> by the AI engine
          and your peers, <strong className="text-text-primary">Earn rewards</strong> that compound
          over time, and <strong className="text-text-primary">Publish</strong> your best work as
