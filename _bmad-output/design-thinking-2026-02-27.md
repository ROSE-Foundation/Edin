# Design Thinking Session: Edin — Founding Contributor Experience

**Date:** 2026-02-27
**Facilitator:** Fabrice
**Design Challenge:** The Founding Contributor Experience — attracting, admitting, activating, and retaining Edin's first 20-30 contributors before the full platform exists
...
**Methods applied:** User Interviews (simulated persona-based), Empathy Mapping, Journey Mapping, Jobs to be Done

To understand our founding contributors, we constructed four representative personas drawn from the platform description's four strategic categories — and then walked in their shoes.

---

**Persona 1: "Lena" — Senior Backend Developer (Technology & Development)**

- 12 years experience, currently freelancing after leaving a FAANG company
...
**Persona 3: "Sofia" — Impact & ESG Analyst (Impact & Sustainability)**

- 6 years in social impact consulting, currently at a multilateral development bank
- Passionate about financial inclusion and how decentralized systems could serve underbanked populations
- Motivated by Rose's non-profit structure and stated mission of societal regeneration
- Has some technical literacy but is not a developer; writes well, thinks systemically
- What she really wants: to help shape something meaningful at the architecture level, not just be handed "write the blog posts" tasks
- Her fear: being sidelined as "the non-technical person" in a technical community
- Her trigger to join: evidence that Impact & Sustainability is a real pillar, not a marketing line

**Persona 4: "Yuki" — Governance & DAO Specialist (Consciousness & Governance)**

- Former lawyer turned Web3 governance designer; contributed to MakerDAO, Optimism Collective, and Gitcoin governance
- Deep expertise in MiCA regulation, EU digital identity, and DAO legal wrappers
- Highly selective about where she spends time — has been burned by DAOs with "decentralized" in the name and autocratic founders in practice
- What she really wants: genuine shared governance, not a founder with a "governance" label on a top-down structure
- Her fear: joining a project that talks about progressive decentralization but never actually decentralizes
- Her trigger to join: a credible governance roadmap with real milestones and real power delegation
...
> A highly skilled professional considering contributing to Edin **needs** to feel that their specific type of expertise is genuinely valued, that the people already involved are worth collaborating with, and that their early commitment will be recognized and rewarded disproportionately — **because** they have been burned by projects that promised the future and delivered nothing, they have limited discretionary time competing against many demands, and they will not invest in a community where they feel like a second-class citizen.

**Supporting POVs by persona:**

> **Lena (Developer)** needs to see that AI evaluation is credible and that code quality — not just code quantity — is what matters, **because** her greatest frustration is that open-source contribution is measured by vanity metrics, not craft.

> **Amir (Financial Engineer)** needs a clear, respected contribution path for non-code expertise, **because** he has deep domain knowledge that is essential to Rose but has no idea how to contribute it in a developer-centric community.

> **Sofia (Impact Analyst)** needs evidence that Impact & Sustainability is a structural pillar with real decision-making power, not a decorative label, **because** she has seen too many tech projects use "social impact" as marketing while engineers make all the real decisions.

> **Yuki (Governance Specialist)** needs a credible, time-bound governance decentralization roadmap with concrete power transfers, **because** she has watched DAOs promise decentralization and deliver founder autocracy, and she will not lend her reputation to another one.

### How Might We Questions

**Attract:**

1. How might we make the founding contributor roster itself the most compelling recruitment tool — so that each new name added increases the pull for the next?
2. How might we signal to non-developer experts (financial engineers, impact analysts, governance designers) that their contributions are structurally equal to code — not in words, but in visible practice?
3. How might we communicate the scaling-law reward vision in a way that creates intellectual excitement without triggering "another empty token promise" skepticism?
...
10. How might we give founding contributors genuine co-creation power over Edin's design — so they feel like co-founders, not early users?
11. How might we create "compounding belonging" — where each week of participation makes leaving feel like a greater loss than staying?
12. How might we provide meaningful feedback on contribution quality before the AI evaluation engine exists?
...
The gap between "accepted" and "first meaningful contribution" is where most community platforms lose people. A contributor who is admitted on Monday and hasn't done anything meaningful by Wednesday is already mentally checked out. The onboarding experience must compress this gap to near-zero: admission → welcome → curated first task → completion → peer feedback → visible recognition, all within the first session.
...
**Methods applied:** Brainstorming, SCAMPER Design, Analogous Inspiration, Provotype Sketching

- **Brainstorming** — for volume: generate 25+ ideas across all four phases (attract, admit, activate, retain) without judgment
- **SCAMPER** — for systematic exploration: apply each lens (Substitute, Combine, Adapt, Modify, Purpose, Eliminate, Reverse) to existing onboarding patterns from other platforms
- **Analogous Inspiration** — for breakthrough thinking: draw from jazz ensembles, garden cultivation, academic research labs, and elite sports draft systems
- **Provotype Sketching** — for extreme versions: push 3-4 ideas to their most radical form to find the useful kernel inside

### Generated Ideas

**ATTRACT — Making People Want In (8 ideas)**
...
4. **Scaling Law Explainer as Intellectual Bait** — Create a standalone, shareable explainer (interactive web page or short paper) about how the scaling-law reward methodology works, grounded in the ORTFM research. Aimed at the Amirs of the world — people who would join just to work on the math.

5. **Rose Research Preview Access** — Give founding contributors early access to unpublished Rose research, ORTFM papers, or Alpha Engine technical details. Knowledge as currency — people who value intellectual depth will join for access to ideas they can't get elsewhere.
...
11. **"Founding Contributor" Title with Real Meaning** — The title isn't just a label. Founding contributors get: permanent governance voting weight bonus (even as the community grows), name on the Edin genesis block (blockchain-recorded), and a voice in designing the evaluation criteria that will assess all future contributors. These are irreversible privileges.

12. **Transparent Admission Criteria Matrix** — Publish the exact criteria used for admission, with explicit weights across: domain expertise (40%), values alignment (25%), contribution potential (20%), and community endorsement (15%). No black box. Applicants know exactly what's being evaluated and can self-select.

13. **Graceful Rejection with Value** — Rejected applicants receive: a personalized note explaining the decision (not a template), specific suggestions for strengthening a future application, and an invitation to follow the project publicly. The goal: even rejected applicants become ambassadors, not adversaries.

14. **Cohort-Based Admission** — Instead of rolling individual admission, admit contributors in small cohorts (5-8 people) monthly. Each cohort goes through onboarding together, building bonds from day one. Modeled on startup accelerator batches and academic cohorts.

**ACTIVATE — Making the First Session Count (7 ideas)**
...
18. **Buddy System** — Every new contributor is paired with an existing contributor in a similar domain for their first 30 days. The buddy's job: answer questions, provide context, give informal feedback, and make the newcomer feel not-alone. Buddy activity is itself a recognized contribution.

19. **Visible Contribution Wall** — A real-time feed (on the web portal or even a shared channel) showing every contribution as it happens across all domains: "Lena reviewed PR #47," "Amir submitted scaling-law parameter analysis," "Sofia published impact assessment v1," "Yuki proposed governance amendment #3." Makes ALL contribution types visible and equal. Creates social proof of activity.

20. **"What I Learned This Week" Ritual** — A weekly 15-minute async or sync session where 2-3 contributors share one thing they learned while contributing. Low-pressure, high-signal. Creates a culture of learning and vulnerability from the start.

21. **Quick Wins Board** — A special section of the contribution menu with tasks that can be completed in under an hour by a newcomer. These are curated to be meaningful (not busywork) but achievable. Completing a quick win triggers immediate peer recognition.

**RETAIN — Making Leaving Feel Impossible (7 ideas)**

22. **Governance Stake Escalation** — Founding contributors accumulate governance weight over time. Each month of active participation increases their voting power. This creates compounding switching costs: leaving means forfeiting accumulated governance influence that cannot be rebuilt elsewhere.

23. **Quarterly "State of Edin" Co-Creation Sessions** — Every quarter, the entire community participates in a structured session to review progress, debate priorities, and vote on the next quarter's focus. Contributors who shape strategy feel ownership. Ownership creates retention.

24. **Peer Feedback Loops (Pre-AI)** — Until the AI evaluation engine exists, implement structured peer feedback: every contribution of substance gets a brief written review from at least one peer. This provides the "someone noticed my work" signal that is the single strongest retention driver in community platforms.

25. **"Your Fingerprints Are Everywhere" Dashboard** — A personal page showing each contributor exactly where their contributions have been incorporated: which features their code is in, which decisions their proposals influenced, which documents their edits improved. Concrete, visual evidence that they matter.

26. **Escalating Commitment Design** — Structure the first 90 days as a deliberate progression: Month 1 = explore and contribute (low commitment), Month 2 = join a working group and take a role (medium commitment), Month 3 = propose an initiative or mentor a newcomer (high commitment). Each step deepens investment naturally.

27. **Annual Founding Contributor Gathering** — An in-person or high-quality virtual event exclusively for founding contributors. Creates social bonds, celebrates progress, and reinforces the "founding generation" identity. Physical presence creates emotional stickiness that digital channels cannot replicate.

28. **"If You Leave, This Is What You Lose" Transparency** — Make the value of continued participation tangible and visible: accumulated governance weight, compounding reward trajectory, reputation score progression, influence on evaluation criteria. Not as a threat — as a clear-eyed dashboard of what sustained engagement builds.

### Top Concepts

After clustering and evaluating all 28 ideas against feasibility (can it be done with current resources?), impact (does it address core persona needs?), and differentiation (does it make Edin unlike anything else?), three concepts emerge as the strongest:
...
**Why this concept:** It directly addresses the 72-hour window insight, ensures that non-developer contributors have immediate pathways, provides the "someone noticed" signal before AI evaluation exists, and creates a repeatable, scalable onboarding flow that works for every cohort.
...
**Integrated Prototype: "The First Cohort"**

Rather than prototyping each concept in isolation, combine all three into a single integrated experiment: **recruit and onboard the first cohort of 5-8 founding contributors through the full experience.**

This is a Wizard of Oz prototype at the highest level — the entire Edin founding contributor experience, operated manually by a small team (even just Fabrice + 1-2 helpers), with no platform technology.

**The prototype flow:**

**Week 0 — Preparation:**

- Draft "The Founding Circle" page: a beautifully designed static page (even a well-crafted PDF or Notion page) listing the project, the vision, and the founding team
- Create the four domain manifestos (short, compelling, domain-specific)
- Prepare the contribution menu: 15-20 curated tasks across all four domains, tagged by difficulty and effort
- Set up four working group channels (Slack or Discord)
- Prepare the "contribution wall" channel (a shared feed where contributions are posted)
- Draft the contribution-based application prompts (one per domain)
- Identify 10-15 potential founding contributors through personal networks

**Week 1 — Recruit & Admit (The Founding Circle + Admission):**

- Personally reach out to 10-15 candidates with a tailored message referencing the Founding Circle page and the relevant domain manifesto
- Those who express interest receive the contribution-based application: a domain-specific micro-task
- Review submitted micro-contributions (Fabrice + 1-2 existing team members)
- Admit 5-8 contributors. Send a personal welcome message explaining Founding Contributor privileges
- Schedule welcome calls within 48 hours of admission

**Week 2 — Activate (72-Hour Ignition):**

- Conduct peer welcome calls (2-3 existing team members + the new contributor, 30 minutes)
- During the call: introduce the working groups, walk through the contribution menu, help them select their first task, assign a buddy
- Contributor completes first task (supported by buddy)
- Peer feedback provided within 24 hours of task completion
- Contribution posted to the contribution wall with recognition
- Contributor invited to their domain working group

**Weeks 3-4 — Retain & Observe:**

- Working groups hold their first meetings (even if only 2-3 people per group)
- "What I Learned This Week" session held at end of week 3
- Observe: who is active? Who went silent? What worked? What felt awkward?
- Conduct brief exit/continuation interviews with all participants at end of week 4
...
**Testing approach:** Real-world pilot with 5-8 genuine founding contributors, not simulated users.

Design thinking tests with real users, not surveys or focus groups. The entire prototype described above IS the test — it runs with real people making real contributions in real time. Here is the structured testing plan:
...
1. **Behavioral metrics (quantitative):**
   - Application completion rate (of those contacted)
   - Time from admission to first contribution (target: <72 hours)
   - Contributions per contributor per week
   - Working group meeting attendance
   - Contribution wall posts per domain
   - 30-day retention rate (still active at week 4)

2. **Experience interviews (qualitative):**
   - Brief structured interview with each contributor at end of week 2 (mid-pilot) and week 4 (end-pilot)
   - Questions:
     - "On a scale of 1-5, how valued do you feel in this community?"
     - "Describe your first 72 hours. What stood out?"
     - "Do you feel your type of contribution is respected equally to others? Why/why not?"
     - "What almost made you not apply? What almost made you disengage?"
     - "Would you invite someone you respect to join? Why/why not?"
     - "What's missing? What would make this experience significantly better?"
   - For contributors who went silent: reach out with a short, non-judgmental check-in to understand why

3. **Observation notes (ethnographic):**
   - Note energy levels in welcome calls and working group meetings
   - Track which contribution types get the most engagement
   - Observe whether the contribution wall creates a sense of momentum or feels performative
   - Watch for signs of developer-centrism creeping into conversations
...
**Anticipated feedback patterns (based on persona analysis and analogous community launches):**

This section will be populated with real data after the pilot. Below are predicted feedback themes based on deep empathy work, to be validated or invalidated:
...
- "The contribution menu needs more tasks in my domain — I ran out of things to do after the first one." (Especially likely for Impact and Governance, where early-stage tasks may be less defined)
- "Peer feedback was nice but inconsistent — some people got detailed reviews, others got 'looks good.'" (Quality variance in manual peer feedback)
- "I still don't fully understand how the scaling-law rewards will work for me personally." (Reward model comprehension gap persists)
- "The tools feel scattered — Slack here, GitHub there, Notion over here. When does the actual platform exist?" (Integration friction in the manual prototype)
- "Working group meetings with 2-3 people felt promising but fragile — one person missing and the energy drops." (Small-group vulnerability)
...
**Framework for synthesizing test results (to be applied after the pilot):**

Learnings will be organized across four dimensions:

**1. Validated assumptions (keep and scale):**

- Which elements of the experience worked as designed?
- What behaviors matched our predictions?
- What should be systematized and repeated for the next cohort?

**2. Invalidated assumptions (pivot or redesign):**

- Which elements fell flat or backfired?
- Where did real behavior deviate from predicted behavior?
- What needs fundamental rethinking?

**3. Surprises (new insights):**

- What did we not anticipate at all?
- What emerged organically that we should formalize?
- What did contributors do that we didn't design for?

**4. Missing pieces (gaps to fill):**

- What did contributors need that we didn't provide?
- What questions came up repeatedly that we couldn't answer?
- What adjacent experiences need design attention?
...
3. **Scaling-law reward communication.** The empathy work revealed that reward model comprehension is a persistent challenge. Before the pilot, develop a clear, visual, one-page explainer of the scaling-law reward model — focused on what it MEANS for the contributor ("here's how your rewards grow over time"), not how it WORKS mathematically. Test comprehension with 2-3 people before using it in the pilot.

4. **Founding Contributor privileges specificity.** "Permanent governance weight bonus" and "design authority over evaluation criteria" need to be made concrete. Before the pilot, define exactly: What can founding contributors vote on? How much additional governance weight do they receive? What is the mechanism for influencing evaluation criteria? Vague privileges feel like empty titles.

5. **Tooling consolidation.** The manual prototype uses Slack + GitHub + Notion + video calls. This is already scattered. Evaluate whether Notion alone (or a single primary workspace) can serve as the hub, with GitHub and Slack as satellites. Contributors should have ONE place they go to see everything.

6. **Exit interview design.** Finalize the structured interview guide before the pilot begins. Include both quantitative scales (1-5 ratings for key experience dimensions) and open-ended prompts. Prepare a separate, gentler check-in script for contributors who disengage — these conversations often yield the most valuable insights.

**Post-pilot refinements (anticipated based on predicted pain points):**

7. **Task replenishment cadence.** The contribution menu will need regular refreshing. Assign someone the explicit responsibility of adding 3-5 new tasks per domain per week. A stale menu signals a stale community.

8. **Working group facilitation guides.** With 2-3 people per group, facilitation matters enormously. Prepare lightweight guides for working group leads: suggested agenda structures, icebreaker questions, and how to run a productive 30-minute meeting with a tiny group.

9. **Bridge from manual to automated.** After the pilot, document which manual processes must be automated first for the next cohort. Likely priority order: contribution wall (automate from GitHub/tool integrations), peer feedback dispatch (automate assignment), and contributor dashboard (automate contribution tracking).
...
> **30-day retention rate of founding contributors: target >50%**
>
> This is the single number that matters most. If more than half of admitted founding contributors are still actively contributing after 30 days — without token rewards, without AI evaluation, without a platform — then the intrinsic motivation hypothesis is validated, and the founding experience design works.
...
> 20+ active founding contributors by end of Phase 1, with >50% retention quarter-over-quarter, across all four strategic domains — forming the cultural and governance nucleus around which Edin scales.
