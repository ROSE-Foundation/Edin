import type { DomainManifesto } from '../types/manifesto.types.js';

export const DOMAIN_MANIFESTOS: DomainManifesto[] = [
  {
    domain: 'Technology',
    title: 'Technology',
  ...
  },
  {
    ...
    subtitle: 'Measuring what matters beyond the bottom line',
    content:
  ...
  },
  {
    domain: 'Governance',
    title: 'Governance',
    subtitle: 'Stewarding progressive decentralization',
    content:
